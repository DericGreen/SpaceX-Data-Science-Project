...
def get_scatter_chart(entered_site,payload_slider):
    filtered_df1 = spacex_df[(spacex_df['Payload Mass (kg)'] >= min_payload) & (spacex_df['Payload Mass (kg)'] <= max_payload)]
    if entered_site == 'ALL':
        ...
        filtered_df2 = filtered_df1[spacex_df['Launch Site']==str(entered_site)]
